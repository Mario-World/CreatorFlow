        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="space-y-3.5 pt-1">
              <button
                type="button"
                onClick={() => setCurrentArea('content')}
                className="w-full text-left flex items-start gap-3.5 p-2.5 rounded-xl transition-all hover:bg-[#121520] group border border-transparent hover:border-[#22273a]"
              >
                <div className="w-7 h-7 rounded-lg bg-[#141622] border border-[#252a3b] group-hover:border-sky-500/40 flex items-center justify-center text-xs font-mono font-medium text-white shrink-0 mt-0.5">
                  1
                </div>
                <div>
                  <h4 className="text-base font-medium text-white group-hover:text-sky-300 transition-colors flex items-center gap-2">
                    <Upload className="w-4 h-4 text-sky-400" />
                    <span>Upload</span>
                  </h4>
                  <p className="text-sm text-[#939baa] mt-0.5 leading-relaxed">
              ...
              <button
                ...
                className="w-full text-left flex items-start gap-3.5 p-2.5 rounded-xl transition-all hover:bg-[#121520] group border border-transparent hover:border-[#22273a]"
              >
                <div className="w-7 h-7 rounded-lg bg-[#141622] border border-[#252a3b] group-hover:border-emerald-500/40 flex items-center justify-center text-xs font-mono font-medium text-white shrink-0 mt-0.5">
                  2
                </div>
                <div>
                  <h4 className="text-base font-medium text-white group-hover:text-emerald-300 transition-colors flex items-center gap-2">
              ...
              <button
                ...
                className="w-full text-left flex items-start gap-3.5 p-2.5 rounded-xl transition-all hover:bg-[#121520] group border border-transparent hover:border-[#22273a]"
              >
                <div className="w-7 h-7 rounded-lg bg-[#141622] border border-[#252a3b] group-hover:border-purple-500/40 flex items-center justify-center text-xs font-mono font-medium text-white shrink-0 mt-0.5">
                  3
                </div>
                <div>
                  <h4 className="text-base font-medium text-white group-hover:text-purple-300 transition-colors flex items-center gap-2">
            ...
            <div className="pt-2 flex flex-wrap items-center gap-3">
              <button
                type="button"
                onClick={() => setCurrentArea('content')}
                className="px-5 py-3 rounded-xl bg-white text-black font-medium text-sm sm:text-base hover:bg-neutral-200 transition-all flex items-center gap-2 shadow-lg"
              >
              ...
              <button
                type="button"
                onClick={() => setCurrentArea('workspace')}
                className="px-5 py-3 rounded-xl bg-[#12141c] hover:bg-[#181b26] text-white font-medium text-sm sm:text-base border border-[#232736] transition-all flex items-center gap-2"
              >
              ...
              <button
                type="button"
                onClick={() => setCurrentArea('publish')}
                className="px-4 py-3 rounded-xl bg-[#12141c] hover:bg-[#181b26] text-[#c0c5d5] font-medium text-sm sm:text-base border border-[#232736] transition-all flex items-center gap-2"
              >
